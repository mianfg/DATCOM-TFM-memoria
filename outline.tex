...
``High: 80°C'', the LLM processing Chunk B lacked the context to know
...
ensuring a temperature threshold of 5000°C is flagged as impossible for
a steel vessel).
...
is 50°C.'' (Simple extraction). 2. \textbf{Type II (Tabular):} Rules
