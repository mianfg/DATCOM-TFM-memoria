...
Due to the unavailability of labeled historical anomaly logs (a common constraint in industrial projects), we developed a \textbf{synthetic evaluation methodology}. More details in \Cref{ch:evaluation}.
\begin{description}
