...
\DeclareFloatingEnvironment[listname={Index of programs},placement=H]{program}
...
\newcommand{\usermsg}[1]{%
  \begin{tcolorbox}[llmstyle=blue,title=\faUser\ User Message]
  #1
  \end{tcolorbox}
}
...
\newtcolorbox{UserMessage}[1][]{%
  ...
  colback=blue!5,
  colframe=blue!60,
  borderline west={3pt}{0pt}{blue!80},
  fonttitle=\bfseries,
  title=\faUser\ User Message,
  #1
}
...
\newtcolorbox{AssistantMessage}[1][]{%
  ...
  colback=green!5,
  colframe=green!60,
  borderline west={3pt}{0pt}{green!80},
  fonttitle=\bfseries,
  title=\faCommentDots\ AI Message,
  #1
}
...
% BIBLIOGRAPHY
% =============================================================================
\usepackage[backend=biber,style=apa,maxbibnames=9,maxcitenames=2,citestyle=numeric]{biblatex}
