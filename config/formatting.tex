...
\lstset{
    literate=%
        ...
        {Á}{{\'A}}1 {Í}{{\'I}}1 {É}{{\'E}}1 {Ý}{{\'Y}}1 {Ú}{{\'U}}1 {Ó}{{\'O}}1
        {Ě}{{\v{E}}}1 {Š}{{\v{S}}}1 {Č}{{\v{C}}}1 {Ř}{{\v{R}}}1 {Ž}{{\v{Z}}}1
        {Ď}{{\v{D}}}1 {Ť}{{\v{T}}}1 {Ň}{{\v{N}}}1 {Ů}{{\r{U}}}1 {º}{{\textdegree}}1
}
...
\lstset{ 
    ...
    keywordstyle=\color{bluekeywords},
    stringstyle=\color{redstrings},
    frame=none,%single,            % puts a box around the listing
    framesep=0pt,%15pt,
    basicstyle=\ttfamily\normalsize,
    linewidth=\textwidth,    % make it span the text width
    xleftmargin=0pt,         % no extra left margin
    xrightmargin=0pt,        % no extra right margin
    escapeinside={(*@}{@*)}, % for LaTeX commands inside listing
    breaklines=true,          % allow long lines to wrap
    showstringspaces=false
}

\definecolor{greencomments}{RGB}{0,128,0}
\definecolor{bluekeywords}{RGB}{0,0,255}
\definecolor{redstrings}{RGB}{200,0,0}
\definecolor{promptbg}{RGB}{245,245,245} % light gray background for prompts
\definecolor{codebg}{RGB}{240,248,255}   % light blue background for code
